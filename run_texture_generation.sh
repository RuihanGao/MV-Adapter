...
# CUDA_VISIBLE_DEVICES=0 python -m scripts.texture_i2tex --image $midi_dir/assets/data/midi_images_20250515/07_vase_table.png --mesh $midi_dir/output/07_vase_table.glb --save_dir output --save_name 07_vase_table --remove_bg
